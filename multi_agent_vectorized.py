...
def run_vectorized_benchmark(num_agents=500000, steps=100):
    ...
    # Scarcity Parameter: Replenishment reduced by 66% (0.001 x N)
    ...
    for step_num in range(1, steps + 1):
        # Adaptive Multi-tier Dynamic Thresholds under Scarcity
        if health < 50.0:
            tax_threshold = 0.15
        elif health < 80.0:
            tax_threshold = 0.20
    ...
    print("\n=== RESOURCE SCARCITY STRESS BENCHMARK COMPLETE ===")
